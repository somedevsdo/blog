...
author: "andy"
slugPath: "accessible-custom-focus-indicators"
subtitle: "Stuff that keeps me awake at night: my phone, my batting average in 2004, and worrying about accessibility. What if I've built a component that not everyone can use? We now all know that accessibility isn't just a nice to have."
---
...
<ThemeableImage
  alt="Two inputs styled like Safari, one without focus and one with focus. Demonstrating that it is not accessible against 3:1 contrast guideline"
  src={import("../../images/posts/accessible-focus1.png")}
/>
...
<ThemeableImage
  alt="Example of GOV.UK's input focus, showing that it partially passes the W3C guidance"
  src={import("../../images/posts/accessible-focus2.png")}
...
<ThemeableImage
  alt="Demo of the non-text contrast example in the W3C guidelines"
  src={import("../../images/posts/accessible-focus3.png")}
/>
...
<ThemeableImage
  alt="Demonstrating outline vs box-shadow. Showing that outline does not hug rounded corners, whilst the box shadow does"
  src={import("../../images/posts/accessible-focus4.png")}
/>
...
<ThemeableImage
  alt="Two inputs demonstrating that outline offset gives some clarity to exactly where the focus is"
  src={import("../../images/posts/accessible-focus5.png")}
/>
